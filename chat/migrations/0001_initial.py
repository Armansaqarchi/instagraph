# Generated by Django 4.1.7 on 2023-09-02 13:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member1', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='member1', to='accounts.account')),
                ('member2', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='member2', to='accounts.account')),
            ],
        ),
        migrations.AddIndex(
            model_name='basemessage',
